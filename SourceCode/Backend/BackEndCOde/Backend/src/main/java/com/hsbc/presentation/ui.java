...
public class ui {
    ...
    private void removeUser() {
        ...
        boolean success = false;
        try {
            success = adminService.removeUser(userId);
    ...
    private void createMeetingRoom() {
        ...
        boolean success = false;
        try {
            success = adminService.makeMeetingRoom(meetingRoom);
    ...
    private void removeMeetingRoom() {
        ...
        boolean success = false;
        try {
            success = adminService.deleteMeetingRoom(roomId);
    ...
    private void updateMeetingRoom() {
        ...
        boolean success = false;
        try {
            success = adminService.updateMeetingRoom(meetingRoom);
        } catch (MeetingNotFoundException e) {
    ...
    private void viewAllMeetingRooms() {
        ...
        try {
            meetingRooms = adminService.getAllMeetingRooms();
        } catch (ConnectionFailedException e) {
    ...
    private void viewAllBookings() {
        ...
        try {
            bookings = adminService.getBookingDetails();
    ...
    private void bookMeeting() {
        ...
        boolean success = false;
        try {
            success = managerService.bookMeeting(booking);
        } catch (ConnectionFailedException e) {
    ...
    private void addUserToMeeting() {
        ...
        boolean success = false;
        try {
            success = managerService.addUserToMeeting(bookingId, userId);
        } catch (UserNotFoundException e) {
    ...
    private void searchUsers() {
        ...
        try {
            users = managerService.searchUsers(keyword);
        } catch (UserNotFoundException e) {
            users.forEach(System.out::println);
        }
    ...
    private void viewBookings() {
        ...
        List<Booking> bookings = null;
        try {
            bookings = managerService.viewBookings(managerId);
        } catch (BookingNotFound e) {
            bookings.forEach(System.out::println);
        }
    ...
    private void viewMeetingDetails() {
        ...
        try {
            booking = managerService.getMeetingDetails(bookingId);
        } catch (MeetingNotFoundException e) {
    ...
    private void viewMyMeetings() {
        ...
        List<Booking> bookings = null;
        try {
            bookings = userService.viewUserMeetings(userId);
        } catch (UserNotFoundException e) {
            bookings.forEach(System.out::println);
        }
...
//import com.hsbc.services.ManagerServiceImpl;
//import com.hsbc.services.UserServiceImpl;
//import com.hsbc.utils.CreditScheduler;
//
//import java.time.LocalDateTime;
//import java.util.List;
//
